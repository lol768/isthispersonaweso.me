...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="masthead">
        <h3 class="muted">isthispersonawesome? Admin Panel</h3>
        <div class="navbar">
...
<form class="formsearch" method="post" action="sessionend.php">
<button name="end" type="end" class="btn btn-large btn-inverse">End Session</button>
    </form>
